...
public class MsgRouteEngine {
    ...
    public MsgRouteEngine(ControllerEngine controllerEngine) {
        this.controllerEngine = controllerEngine;
        this.plugin = controllerEngine.getPluginBuilder();
        this.logger = plugin.getLogger(MsgRouteEngine.class.getName(),CLogger.Level.Info);
